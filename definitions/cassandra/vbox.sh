...
/etc/init.d/virtualbox-ose-guest-utils stop > /dev/null  2>&1
rmmod vboxguest > /dev/null  2>&1
aptitude -y purge virtualbox-ose-guest-x11 virtualbox-ose-guest-dkms virtualbox-ose-guest-utils > /dev/null  2>&1
